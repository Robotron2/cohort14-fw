...
import { MARKET_STATS } from "../utils/helpers";

// Hero images for carousel display
const HERO_BG =
    ...
    <div className="page-enter">
      ...
      >
        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10">
          <div ref={heroTextRef} className="max-w-4xl space-y-6 md:space-y-8">
            <span
            ...
            >
              ...
              premium coastal assets. Dive into the deep end of digital
              property.
            </p>
      ...
      <section
        ref={statsRef}
        className="py-16 md:py-24 bg-surface-container-low border-y border-outline-variant/5"
      >
        <div className="container mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-12 text-center">
            <div className="scroll-reveal">
              <StatCard
                label="Total Volume"
                value={MARKET_STATS.totalVolume}
                sub={MARKET_STATS.volumeChange}
                subIcon="trending_up"
              />
            </div>
            <div className="scroll-reveal" style={{ transitionDelay: "0.1s" }}>
              <StatCard
                ...
                value={MARKET_STATS.activeProperties}
        ...
        <div className="container mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {featuredProperties.length > 0 ? (
              ...
              <div className="col-span-3 text-center py-20 text-on-surface-variant font-body">
              ...
              {[
                {
                  ...
                  desc: "Exit your property position in seconds, not months.",
                },
                {
                  icon: "token",
                  title: "Fractionalization",
                  desc: "Own a piece of a $50M villa for as little as $1,000.",
                },
                {
                  icon: "verified_user",
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-surface-container-high to-surface rounded-3xl overflow-hidden border border-outline-variant/20 rotate-2 md:rotate-3">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8 md:p-12">
                <div className="glass-card p-6 md:p-8 rounded-2xl border border-primary/20 -rotate-2 md:-rotate-3 translate-x-4">
